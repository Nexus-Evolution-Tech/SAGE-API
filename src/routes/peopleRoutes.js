...
routerExtra.get('/pessoas/:id/foto', autenticar, peopleController.servirFotoPessoa);
routerExtra.post('/pessoas/upload/:id', autenticar, upload.single('foto'), peopleController.uploadFoto);
