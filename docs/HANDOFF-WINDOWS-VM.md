...
- O branch remoto tem commits documentais posteriores ao baseline; use o HEAD atual de
  `origin/agent/f8-uninstall` ao clonar, sem fixar um SHA documental neste texto.
